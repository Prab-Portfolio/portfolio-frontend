...
export function Mac({ open, hinge, ...props}) {
  ...
  return (
    <group ref={refs} position={[0, 2.96, -0.13]} {...props} onPointerOver={(e) => (e.stopPropagation(), setHovered(true))} onPointerOut={(e) => setHovered(false)} dispose={null}>
      <three.group rotation-x={hinge} position={[0, 1.04, 0.41]}>
        <group position={[0, 2.96, -0.13]} rotation={[Math.PI / 2, 0, 0]}>
          ...
          <Html rotation-x={-Math.PI / 2} position={[-0.6, 0.039, -0.09]} transform occlude>
            <MacScreenWrapper>
              <AboutMeMac/>
            </MacScreenWrapper>
          </Html>
      ...
      <mesh geometry={nodes.keyboard.geometry} material={materials.keys} position={[1.793, 1.1, 3.451]} />
      <group position={[0, 1.0, 3.394]}>
      ...
      <mesh geometry={nodes.touchbar.geometry} material={materials.touchbar} position={[0, 1.1, 1.201]} />
    </group>
  )
}
